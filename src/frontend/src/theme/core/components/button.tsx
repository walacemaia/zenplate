    ...
    style: ({ theme }) => ({
      ...(color === 'secondary'
        ? {
            ...
            '&:hover': {
              backgroundColor: varAlpha(theme.vars.palette.primary.mainChannel, 0.28),
              borderColor: varAlpha(theme.vars.palette.primary.mainChannel, 0.36),
            },
...
const MuiButton: Components<Theme>['MuiButton'] = {
  ...
  styleOverrides: {
        ...
        colors: styleColors(ownerState, (color) => ({
          ...(color === 'secondary'
            ? {
                ...
                '&:hover': {
                  borderColor: varAlpha(theme.vars.palette.primary.mainChannel, 0.56),
    ...
    text: ({ ownerState, theme }) => {
      ...
      return { ...styled.secondaryColor, ...styled.inheritColor };
    },
    /**
     * @sizes
     */
